...
Try:
    ...
    ``$ ./cranial pipe postgresql://your.host:5439/name/table?last_id=0 ssh://you@example.com:22022/file.json.bzip2``

    ``$ ./cranial pipe db://your.host/name/table?driver=mysql hdfs://example.com/path/to/file.json.gz ``

    ``$ ./cranial pipe tweets://yourname:password@#someTag fb://yourname:password@ # Easy to implement.``
